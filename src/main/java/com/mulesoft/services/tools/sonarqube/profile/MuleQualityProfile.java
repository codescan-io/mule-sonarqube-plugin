...
public class MuleQualityProfile implements BuiltInQualityProfilesDefinition {
	...
	public void define(Context context) {
		...
		activeRule(profile3, MuleRulesDefinition.MULE3_REPOSITORY_KEY, "file:lib/extensions/rules-3.xml");
		profile3.done();
		...
		activeRule(profile4, MuleRulesDefinition.MULE4_REPOSITORY_KEY, "file:lib/extensions/rules-4.xml");
		profile4.done();
	}
